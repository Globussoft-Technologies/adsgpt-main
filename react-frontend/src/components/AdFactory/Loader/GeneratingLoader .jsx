  ...
  return (
    <div className="backdrop-blur-100 fixed inset-0 z-[999999] flex flex-col bg-[#0D0D0D]/50">
      ...
      <div className="flex min-h-screen flex-col items-center justify-center">
        {/* % TEXT */}
        {/* <p className="mb-10 text-2xl font-medium text-[#AFAFAF]">{progress}%</p> */}

        {/* SPINNER */}
        <img src={SpinnerImage} className="h-20 animate-spin" />

        {/* STATUS TEXT */}
        <p className="mt-10 text-2xl font-normal tracking-wide text-[#AFAFAF]">
          AI is generating script..
        </p>

        {/* SUB TEXT */}
        <p className="mt-9 text-xl text-[#AFAFAF]">This may take 20–30 secs</p>
      </div>
