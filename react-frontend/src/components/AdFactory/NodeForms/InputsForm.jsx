        ...
        {tags.map((tag, index) => (
          ...
          >
            ...
            <button
              ...
              className="ml-1 text-lg leading-none text-gray-900 hover:bg-black/10 hover:text-black dark:text-white dark:hover:text-white"
              disabled={disabled}
            >
              ×
            </button>
        ...
        {tags.map((tag, index) => (
          ...
          >
            ...
            <button
              ...
              className="ml-1 text-lg leading-none hover:text-black dark:hover:text-white"
              disabled={disabled}
            >
              ×
            </button>
    ...
    return (
      <>
        <button
          ...
          className={`group mb-1.5 flex items-center gap-1 rounded-full px-4 py-2.5 text-sm font-medium backdrop-blur-md transition-all duration-300 hover:shadow-lg 2xl:gap-2 ${
            isResetDisabled
              ...
              : 'text-gray-500 hover:bg-black/5 hover:text-black dark:text-[#AFAFAF] dark:hover:bg-[#1A1A1A] dark:hover:text-white'
          }`}
        ...
        <Dialog open={resetDialogOpen} onOpenChange={setResetDialogOpen}>
          <DialogContent className="z-[9999] flex w-full !max-w-[380px] flex-col overflow-x-hidden rounded-[24px] border-none !bg-gradient-to-b from-white to-white p-6 shadow-2xl shadow-orange-500/10 !backdrop-blur-[100px] dark:from-[#222222] dark:to-[#222222] sm:p-8">
            ...
            <div className="flex w-full flex-col items-center justify-center space-y-4 pt-6">
              <div className="flex w-full items-center justify-center gap-3">
                <button
                  ...
                  className="flex-1 rounded-xl bg-gray-50 px-6 py-2.5 text-sm font-medium text-gray-500 transition-all hover:bg-black/5 hover:text-black dark:bg-[#2A2A2A] dark:text-[#AFAFAF] dark:hover:bg-[#3A3A3A] dark:hover:text-white"
            ...
            <Form className="relative z-10">
              <div className="max-h-[calc(100svh-280px)] space-y-5 overflow-y-auto p-2 py-1.5 sm:pr-5">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <label className="text-sm text-gray-500 dark:text-[#AFAFAF] 2xl:mb-1.5 2xl:text-[18px]">
                      Primary Objective *
                    </label>
                ...
                <div className="flex flex-col">
                  <label className="mb-2 text-sm text-gray-500 dark:text-[#AFAFAF] 2xl:text-[18px]">
                    Promotional Details
                  </label>
                ...
                {/* CTA TAGS */}
                <div className="flex flex-col">
                  <label className="mb-1 text-sm text-gray-500 dark:text-[#AFAFAF] 2xl:text-[18px]">
                    Call To Action
                  </label>
                ...
                <div className="col-span-6 grid grid-cols-6 gap-x-7 gap-y-2.5">
                  ...
                  <div className="relative col-span-6 flex flex-col sm:col-span-3">
                    <label className="mb-1 text-sm text-gray-500 dark:text-[#AFAFAF] 2xl:text-[18px]">Core Idea</label>
                  ...
                  <div className="col-span-6 flex w-full flex-col">
                    <label className="mt-1 mb-2 text-sm text-gray-500 dark:text-[#AFAFAF] 2xl:text-[18px]">
                      Target Audience*
                    </label>
              ...
              <div className="col-span-3 flex flex-wrap items-center justify-end gap-3 pt-6 2xl:pt-9">
                <button
                  ...
                  className="h-10 rounded-lg bg-gray-900 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-emerald-500/20 transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-white dark:text-black 2xl:text-base"
                >
                  {isFormSubmitting ? (
