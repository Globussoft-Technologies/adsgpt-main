      ...
      {!isHidden && (
        <>
          ...
          <img
            ...
            className={`${isGenerated ? 'z-[99]' : 'z-0'} pointer-events-none fixed bottom-0 left-1/2 w-[120vw] -translate-x-1/2 opacity-20 xl:opacity-30 xl:top-[28%] xl:bottom-auto dark:xl:opacity-100`}
            alt=""
          />
        </>
      )}
