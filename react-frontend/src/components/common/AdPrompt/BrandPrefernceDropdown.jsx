    ...
    >
      <PopoverTrigger asChild>
        <div
          ...
          className="prompt_selection_button_no_gradient group 2xl:text-13 relative flex max-w-[200px] cursor-pointer items-center gap-2 rounded-[50px] px-4 py-1.5 text-[9px] shadow-none transition-all duration-200 ease-in hover:bg-slate-100 md:text-[11px] 2xl:py-2 dark:border-none dark:bg-[#0d0d0d]/50 dark:text-[#AFAFAF]"
        >
      ...
      <PopoverContent
        side="bottom"
        align="end"
        className="backdrop-blur-100 mb-2 w-68 rounded-3xl border border-white/20 bg-[#0D0D0D]/50 px-2 py-4 pb-6 2xl:w-86 2xl:pb-8"
      >
        <div className="w-full">
          <Tabs defaultValue="brand" className="flex w-full">
            {/* Tabs header */}
            <TabsList className="mx-auto h-9 w-58 rounded-full border border-white/30 !bg-[#0d0d0d]/60 p-1 2xl:h-12 2xl:w-70 2xl:p-1.25">
              <TabsTrigger
                value="brand"
                ...
                <div className="grid gap-3">
                  ...
                  {uploadedLogo && !isImageUploading && (
                    <div
                      key="static-id"
                      onClick={() => {}}
                      className="prompt_selection_button relative h-12 w-fit flex-shrink-0 cursor-pointer rounded-lg bg-[#202020]/50 p-2.5 backdrop-blur-[80px] transition-all duration-200 hover:shadow-md hover:ring-1 hover:ring-white/40"
                      title="Brand Logo"
                    >
                      <img
                        src={uploadedLogo}
                  ...
                  <div className="grid gap-1">
                    <div className="flex items-center gap-1 2xl:gap-2">
                      <label
                        htmlFor="brand-logo"
                        className="text-[11px] font-normal text-[#afafaf] 2xl:text-sm"
                      >
                        Brand Logo
                      </label>
                      ...
                      >
                        <Info className="h-2.5 w-2.5 cursor-pointer text-gray-400 hover:text-white 2xl:h-3 2xl:w-3" />
                      </ShadcnTooltip>
                    </div>

                    <label
                      htmlFor="brand-logo"
                      className="flex items-center gap-3 rounded-4xl border border-white/20 bg-[#0d0d0d]/50 px-1 py-1 text-[10px] text-[#afafaf] transition 2xl:text-sm"
                    >
                      <div className="flex cursor-pointer items-center gap-1.5 rounded-4xl bg-[#606060] px-2.5 py-1.5 text-[10px] text-white hover:opacity-70 2xl:gap-2">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <Input
                      id="call-to-action"
                      className="h-7! rounded-4xl border text-[10px]! placeholder:text-[10px]! placeholder:text-[#ccc]/60 focus-within:border-white/50 focus:!ring-0 2xl:h-10! 2xl:text-sm! placeholder:2xl:text-sm! dark:bg-[#0d0d0d]/50"
                      value={cta}
              ...
              <div className="mt-4 flex w-full flex-wrap items-center justify-center gap-1 gap-y-2 2xl:gap-2 2xl:gap-y-4">
                {preferenceOptions.map((option) => {
                  ...
                  return (
                    <div
                      key={option.label}
                      className={`flex w-20 cursor-pointer items-center justify-center gap-1 rounded-sm border 2xl:w-25 ${style_type === option.value ? 'border-white/50 bg-[#0d0d0d]/50 text-white' : 'border-white/20 bg-[#313131]/50 text-[#afafaf]'} px-2 py-2 text-[11px] hover:border-white/50 hover:bg-[#0d0d0d]/50 hover:text-white 2xl:text-sm`}
