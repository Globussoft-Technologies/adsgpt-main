...
const AdPromptComponent = () => {
  ...
  const selectPlateformsOptions = [
    ...
    },
    {
      value: 'google',
      Icon: (
        <Search className="!h-3 !w-3 text-zinc-700 transition-colors group-hover:text-zinc-950 2xl:!h-4 2xl:!w-4 dark:text-[#AFAFAF] dark:group-hover:text-white" />
      ),
    ...
    },
    {
      ...
      Icon: (
        <FaGoogle className="!h-3 !w-3 text-zinc-700 transition-colors group-hover:text-zinc-950 2xl:!h-4 2xl:!w-4 dark:text-[#AFAFAF] dark:group-hover:text-white" />
      ),
    ...
    },
    {
      value: 'twitter',
      Icon: (
        <RiTwitterXLine className="!h-3 !w-3 text-zinc-700 transition-colors group-hover:text-zinc-950 2xl:!h-4 2xl:!w-4 dark:text-[#AFAFAF] dark:group-hover:text-white" />
      ),
      label: 'Twitter Ads',
    },
    {
    ...
    },
    {
      ...
      Icon: (
        <Video className="!h-3 !w-3 text-zinc-700 transition-colors group-hover:text-zinc-950 2xl:!h-4 2xl:!w-4 dark:text-[#AFAFAF] dark:group-hover:text-white" />
      ),
