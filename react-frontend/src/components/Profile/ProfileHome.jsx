...
export default function ProfileHome() {
  ...
  return (
    <div className="flex h-full min-h-0 items-start justify-center p-0 text-zinc-900 lg:pt-6 dark:text-white">
      <div className="flex h-full min-h-0 w-full flex-col">
        {/* Two-column area: Profile + Subscription (left), Integrations (right), Credits full width below */}
        {/* Profile Section */}
        <div className="mx-auto flex w-full max-w-[43rem] shrink-0 items-center space-x-6 pb-6 lg:max-w-6xl lg:pb-8 2xl:max-w-7xl">
          ...
          <div className="flex h-full flex-col gap-0">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
              ...
              >
                <LogOut
                  className="h-3 w-3 text-[#64748B] transition-transform delay-0 duration-150 ease-out group-hover:translate-x-px group-hover:delay-75 group-hover:duration-300 motion-reduce:transform-none sm:h-3.5 sm:w-3.5 dark:text-[#A8AFBC]"
                  aria-hidden="true"
                />
                Sign Out
              </Link>
        ...
        <div className="account-profile-content-scroll min-h-0 flex-1 scrollbar-thin overflow-y-auto">
          <div className="mx-auto w-full max-w-[43rem] pb-6 lg:max-w-6xl 2xl:max-w-7xl">
                  ...
                  <div className="flex shrink-0 items-center gap-2">
                    ...
                    {subscriptionType !== '8' && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="cursor-pointer rounded-[50px] border border-red-500 px-3 py-1 text-[11px] font-medium whitespace-nowrap text-red-500 transition-colors hover:bg-red-50 2xl:text-sm dark:border-red-400 dark:text-red-400 dark:hover:bg-red-900/20"
                      >
                        Cancel
                      </a>
                    )}
                  ...
                  <div className="flex flex-wrap justify-center gap-6">
                    ...
                    {!hasPlan8 && (
                      <div className="flex flex-col items-center gap-1">
                        <p className="text-13 font-bold text-zinc-900 dark:text-white">
                          Subscription
                        </p>
                        <div className="flex w-[180px] items-center space-x-2 rounded-lg border border-black/10 bg-zinc-50 p-2.5 dark:border-white/5 dark:bg-[#333333]/50">
                          ...
                          <div className="min-w-0">
                            ...
                            {metaAccounts === undefined ? (
                              ...
                              <p className="text-10 text-zinc-500 dark:text-white/50">
                                {usableMetaAccounts.length} connected Facebook{' '}
                                {usableMetaAccounts.length === 1 ? 'account' : 'accounts'}
                              </p>
                            )}
                          </div>
                          {usableMetaAccounts.length > 0 && (
                            <span className="text-10 rounded-full bg-emerald-100 px-2 py-0.5 font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">
                              Connected
                            </span>
                          )}
                        </div>
                          ...
                          {metaAccounts.map((account) => (
                            ...
                            >
                              <div className="min-w-0">
                                ...
                                <p className="text-10 truncate text-zinc-500 dark:text-white/45">
                                  {account.email || `Facebook ID: ${account.facebookId}`}
                                </p>
                                {!account.isUsable && (
                                  <p className="text-10 mt-0.5 font-medium text-amber-600 dark:text-amber-400">
                                    Reconnect required
                                  </p>
                                )}
                              </div>
            ...
            <div className="mt-6 rounded-2xl border border-black/5 bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.05)] lg:mt-8 dark:border-transparent dark:bg-[#303030]/50 dark:shadow-none">
