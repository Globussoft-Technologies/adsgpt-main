...
import InstaFeed1 from '../Instagram/Feeds/InstaFeed1';
import ReelStories from '../Instagram/Reels&Stories/ReelStories';
import InstagramLogo from '@/assets/layouts/adstudio/adpreview/insta.svg';
import { getAdText } from '@/utils/getAdText';

// Ad components
const adComponents = {
  InstaFeed1: InstaFeed1,
  Story1: ReelStories,
};
...
function AdPreviewInstaMain({
  ...
  const [selectedAd, setSelectedAd] = useState('InstaFeed1');
...
export default memo(AdPreviewInstaMain);
