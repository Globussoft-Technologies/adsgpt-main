...
const AdCreativeCardLoader = () => {
  return (
    <div className="relative z-10 w-full max-w-full animate-pulse overflow-hidden rounded-xl bg-gradient-to-br from-slate-800 to-slate-800 shadow-lg">
      {/* Header */}
      ...
      {/* Image Placeholder */}
      <div className="h-52 w-full bg-slate-600/80 2xl:h-72" />
...
export default AdCreativeCardLoader;
