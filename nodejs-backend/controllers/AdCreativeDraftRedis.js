...
const getDraftKey = (uid) => `draftAdCreative:${uid}`;
...
exports.createDraft = async (req, res) => {
    ...
    try {
        ...
        await redisGetSet.setex(getDraftKey(draftData?.uid+draftData?.uniqueAdCreativeSessionId?? ""), CACHE_EXPIRATION, JSON.stringify(draftData));
