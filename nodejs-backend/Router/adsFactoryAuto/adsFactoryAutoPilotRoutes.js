...
// Not scoped to any job — just mails whatever address is in req.body.to.
// Must be registered before /jobs/:id/* routes.
router.post("/jobs/test-email",   authenticateJWT, ctrl.testAlertEmail);
